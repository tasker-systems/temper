...
api/oauth/clients.ts	route /oauth/clients	RFC 7591 DCR — AS mode only (404 without AS_ISSUER); Connect-class persists to kb_oauth_dcr_clients, MCP-compat class echoes the pre-registered client
