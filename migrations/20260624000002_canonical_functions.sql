-- ============================================================================
-- Temper — canonical baseline functions (migration 2 of 3)
-- ----------------------------------------------------------------------------
-- All SQL functions over the substrate: the access-gating functions (the
-- two-principal sum type), the delegation predicate, the single-transaction
-- cogmap seeding, and the Domain-B read projections. Applies after migration 1
-- (`…01_canonical_schema.sql`).
--
