...
- Create: `migrations/20260708000012_streaming_ingest.sql` — seed `resource_finalized` event type; `block_append()` + `resource_finalize()` SQL functions.
...
**Files:**
- Create: `migrations/20260708000012_streaming_ingest.sql`
...
cargo fmt
git add migrations/20260708000012_streaming_ingest.sql crates/temper-substrate/tests/streaming_ingest_test.rs
