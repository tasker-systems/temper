...
Cloud and ephemeral sessions can bootstrap temper without running the browser OAuth flow by exporting the following variables. See the design spec at `temper-artifacts:specs/2026-04-18-cloud-mode-and-portable-memory-design.md` for the broader cloud-mode design these env vars belong to.
