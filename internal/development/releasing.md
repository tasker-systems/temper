...
`temper-artifacts:spikes/2026-07-29-sigstore-crate-evaluation.md`
...
- `temper-artifacts:specs/2026-04-17-temper-cli-binary-release-design.md` — original design doc
- `temper-artifacts:specs/2026-07-29-binary-attestation-and-manifest-verification-design.md` — per-file manifest + attestation design
