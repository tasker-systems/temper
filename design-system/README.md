...
| `preview/graph-atlas/` | Design targets for the graph-visualization rethink (Atlas direction + semantic-zoom tiers). See its `README.md` and the Atlas spec (`temper-artifacts:specs/2026-07-03-temper-ui-graph-visualization-atlas-design.md`). |
