...
> [standing-up-a-machine-credential](../playbooks/standing-up-a-machine-credential.md).
...
- [Machine credentials](../playbooks/standing-up-a-machine-credential.md) — the operator's side: who may mint a credential, how reach is contained to the minter's own authority, revocation.
- [Working with Teams](../playbooks/run-a-team.md) — the roles and ownership that a machine's reach is expressed in.
- [Building a cognitive map](../playbooks/build-a-cognitive-map.md) — what you are authoring into, and why bulk reconcile is a CLI act.
- [Self-hosting](../playbooks/self-host-temper.md) — standing up the instance whose `/oauth/token` a temper-issued credential mints against.
