...
> | The takeover (`emit` over the hand-written index) | **shipped, not yet taken** on the one adopted machine |
...
That render, on a 183-memory corpus, was 189 lines and 20.5 KB, with 19 entries carrying an
`UNEXAMINED` marker:
...
- [feature unification pulls in ort](temper://019fc011-e40f-72b2-be4b-598ec2f68c71)  [verified 2026-06-19]
- [sqlx::migrate!() stale cache](temper://019fc010-c86e-7ed0-94e7-b36bf255d36c)  [verified 2026-04-21 — UNEXAMINED 103d]
```
...
- **The lazy tail is never forced.** Beyond the cohort you deliberately migrate, files move when
  ...
  `status`.
- **The evidence base is one person, one machine, one client.** The corpus is real (183 memories);
  the multi-writer and multi-environment claims are not.
