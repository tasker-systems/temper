...
**Created:**
- `migrations/20260703000001_resource_reassign_fns.sql` — event-type seed + `_project_resource_reassigned` + `resource_reassign` SQL fns.
...
**Files:**
- Create: `migrations/20260703000001_resource_reassign_fns.sql`
