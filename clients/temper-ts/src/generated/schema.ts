...
export interface paths {
    ...
    "/api/resources/reblock": {
        ...
        post: operations["reblock_resources"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        BlockSuccessor: {
            ...
            /**
             * Format: uuid
             * @description The resource the successor's row lives on — the same value the pair-keyed read fork
        ...
        /**
         * @description A set combinator's operation. Every member takes two or more inputs; no act does, which is why
         ...
         * @enum {string}
         */
        CombineOp: "union" | "intersect" | "difference";
        /**
        ...
        /**
         * @description Whether anything remains BEYOND what the caller received.
         *
        ...
        ReblockCandidate: {
            outcome: components["schemas"]["ReblockOutcome"];
            /**
             * Format: uuid
        ...
        /**
         * @description What happened to one candidate. The act's arms are `Reblocked`, `NoOp`, `Denied`, `InProgress`,
        ...
        ReblockReceipt: {
            ...
            outcomes: components["schemas"]["ReblockCandidate"][];
            summary: components["schemas"]["ReblockSummary"];
        };
        /**
         * @description Request body for `POST /api/resources/reblock` — one bounded, resumable re-blocking step.
         *
        ...
        ReblockRequest: {
            ...
            scope: components["schemas"]["ReblockScope"];
        };
        /**
        ...
        RegionDisclosure: {
            /**
             * Format: uuid
             * @description The region's id, as stored.
             *
            ...
            /**
             * Format: double
             * @description The blend this region matched at. See the type's own note: raw, unbounded, open ruling.
             */
            region_score: number;
        };
        ...
        ResourceFilter: {
            ...
            owner?: string | null;
            /**
             * @description `kb_properties` rows owned by the resource itself: open key space, closed operator set.
             *     AND across the list, OR within a [`PropertyOp::Contains`].
             *
        ...
        ResourceUpdateRequest: components["schemas"]["ActInput"] & {
            ...
            managed_meta?: null | components["schemas"]["ManagedMeta"];
            /**
             * @description Partial open_meta — incoming keys win; absent keys preserved. An explicit **`null`
        ...
        Scoring: {
            /**
             * Format: float
             * @description The DEPRECATED legacy rendering of the row's ordering quantity: a required,
            ...
            /**
             * @description Whether the row actually carried the ordering quantity that `score` renders.
        ...
        StageResult: {
            act: components["schemas"]["ActName"];
            /**
             * @description Which regions a `survey` stage matched, and at what score. Empty for every other act.
             *
             ...
             */
            disclosed_regions?: components["schemas"]["RegionDisclosure"][];
        ...
        StageTrace: {
            ...
            disposition: components["schemas"]["StageDisposition"];
            /**
             * @description Complete / partial / indeterminate — **for every stage, not only the returned ones.** NOT a
             *     total; see [`Extent`].
             *
            ...
            stage: components["schemas"]["StageName"];
            /**
             * @description The APPLIED value of every admitted term: the page this stage actually RAN with, clamped to
...
export interface operations {
    create_request: {
        ...
        responses: {
            ...
            /** @description Too many requests in the current window (rate limit configured by the operator; default unlimited) */
            429: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    reblock_resources: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ReblockRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ReblockReceipt"];
                };
            };
