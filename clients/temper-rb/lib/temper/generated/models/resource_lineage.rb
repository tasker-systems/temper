...
module Temper::Generated
  ...
  class ResourceLineage < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Temper::Generated::ResourceLineage` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Temper::Generated::ResourceLineage`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'descendants')
        if (value = attributes[:'descendants']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @ancestors.nil?
        invalid_properties.push('invalid value for "ancestors", ancestors cannot be nil.')
      end
    ...
    # @param [Object] ancestors Value to be assigned
    def ancestors=(ancestors)
      if ancestors.nil?
        fail ArgumentError, 'ancestors cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] descendants Value to be assigned
    def descendants=(descendants)
      if descendants.nil?
        fail ArgumentError, 'descendants cannot be nil'
      end
    ...
    def hash
      [ancestors, descendants, resource_id].hash
    end
