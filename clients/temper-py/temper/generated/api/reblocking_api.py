...
class ReblockingApi:
    ...
    @validate_call
    def reblock_resources(
        self,
        reblock_request: ReblockRequest,
        ...
        :param reblock_request: (required)
        :type reblock_request: ReblockRequest
        ...
        _param = self._reblock_resources_serialize(
            reblock_request=reblock_request,
    ...
    @validate_call
    def reblock_resources_with_http_info(
        self,
        reblock_request: ReblockRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def reblock_resources_without_preload_content(
        self,
        reblock_request: ReblockRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    def _reblock_resources_serialize(
        self,
        reblock_request,
        x_temper_surface,
        _request_auth,
        ...
        if reblock_request is not None:
            _body_params = reblock_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/resources/reblock',
