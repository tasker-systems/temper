...
class AdoptionApi:
    ...
    def adopt_resources(
        ...
        :param adopt_request: (required)
        :type adopt_request: AdoptRequest
        ...
        _param = self._adopt_resources_serialize(
    ...
    @validate_call
    def adopt_resources_with_http_info(
        self,
        adopt_request: AdoptRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def adopt_resources_without_preload_content(
        self,
        adopt_request: AdoptRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    def _adopt_resources_serialize(
        self,
        adopt_request,
        x_temper_surface,
        _request_auth,
        ...
        if adopt_request is not None:
            _body_params = adopt_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/resources/adopt',
