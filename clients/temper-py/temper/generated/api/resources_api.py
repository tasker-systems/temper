...
class ResourcesApi:
    ...
    @validate_call
    def list_resource_connections(
        self,
        id: Annotated[UUID, Field(description="Resource ID")],
        limit: Annotated[Optional[StrictInt], Field(description="Max connections to return (default 50, clamped to 1..=200).")] = None,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: Resource ID (required)
        :type id: UUID
        :param limit: Max connections to return (default 50, clamped to 1..=200).
        :type limit: int
        :param x_temper_surface: The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.
        :type x_temper_surface: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._list_resource_connections_serialize(
            id=id,
            limit=limit,
            x_temper_surface=x_temper_surface,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_resource_connections_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Resource ID")],
        limit: Annotated[Optional[StrictInt], Field(description="Max connections to return (default 50, clamped to 1..=200).")] = None,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceConnections]:
        """List a resource's relationships, bounded, with the filtered total stated
    ...
    @validate_call
    def list_resource_connections_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Resource ID")],
        limit: Annotated[Optional[StrictInt], Field(description="Max connections to return (default 50, clamped to 1..=200).")] = None,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
    ...
    def _list_resource_connections_serialize(
        self,
        id,
        limit,
        x_temper_surface,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/resources/{id}/connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_block(
        self,
        id: Annotated[UUID, Field(description="Resource ID")],
        block_id: Annotated[UUID, Field(description="Content block ID")],
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: Resource ID (required)
        :type id: UUID
        :param block_id: Content block ID (required)
        :type block_id: UUID
        :param x_temper_surface: The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.
        :type x_temper_surface: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._read_block_serialize(
            id=id,
            block_id=block_id,
            x_temper_surface=x_temper_surface,
            _request_auth=_request_auth,
    ...
    @validate_call
    def read_block_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Resource ID")],
        block_id: Annotated[UUID, Field(description="Content block ID")],
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
    ...
    def _read_block_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/resources/{id}/blocks/{block_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def record_citation_audit_for_block(
        self,
        block_citation_audit_request: BlockCitationAuditRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        The authorization subject is the finding that owns `block_id`, resolved server-side; the caller never names a finding, so a write can only ever land on the citation it addresses.  The act envelope in the body rides the ledger row as authorship and correlation metadata — it never moves standing; only `value` does.

        :param block_citation_audit_request: (required)
        :type block_citation_audit_request: BlockCitationAuditRequest
        :param x_temper_surface: The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.
        :type x_temper_surface: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._record_citation_audit_for_block_serialize(
            block_citation_audit_request=block_citation_audit_request,
            x_temper_surface=x_temper_surface,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def record_citation_audit_for_block_with_http_info(
        self,
        block_citation_audit_request: BlockCitationAuditRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def record_citation_audit_for_block_without_preload_content(
        self,
        block_citation_audit_request: BlockCitationAuditRequest,
        x_temper_surface: Annotated[Optional[StrictStr], Field(description="The calling surface, for event-ledger attribution. Accepted values are `cli` and `sdk`; an absent or unrecognized value attributes the write to `web`. This is provenance, never authorization — an unrecognized value degrades, it never rejects.")] = None,
        _request_timeout: Union[
    ...
    def _record_citation_audit_for_block_serialize(
        self,
        block_citation_audit_request,
        x_temper_surface,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if block_citation_audit_request is not None:
            _body_params = block_citation_audit_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/citation-audits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
