...
class ResourceCreateRequest(BaseModel):
    ...
    doc_type: StrictStr = Field(description="Doc-type name (the substrate stores doc-type as a property name; the backend create path passes it straight through to `CreateResource`).")
