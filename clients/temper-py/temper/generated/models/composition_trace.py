...
class CompositionTrace(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompositionTrace from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompositionTrace from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stages": [StageTrace.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None
        })
        return _obj
