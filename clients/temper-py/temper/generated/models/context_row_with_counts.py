...
class ContextRowWithCounts(BaseModel):
    """
    ...
    updated: datetime
    __properties: ClassVar[List[str]] = ["can_write", "created", "id", "kb_owner_id", "kb_owner_table", "name", "owner_ref", "resource_count", "retired", "slug", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContextRowWithCounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContextRowWithCounts from a dict"""
        if obj is None:
            return None
