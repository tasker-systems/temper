...
class ResourceFilter(BaseModel):
    ...
    """ # noqa: E501
    doc_type: Optional[List[StrictStr]] = Field(default=None, description="`kb_properties` where `property_key = 'doc_type'`.")
    ...
    tags: Optional[List[StrictStr]] = Field(default=None, description="`kb_properties` where `property_key = 'tags'`. AND-containment.")
