...
class ResourceFilter(BaseModel):
    ...
    """ # noqa: E501
    doc_type: Optional[Annotated[List[StrictStr], Field(max_length=64)]] = Field(default=None, description="`kb_properties` where `property_key = 'doc_type'`.")
    ...
    tags: Optional[Annotated[List[StrictStr], Field(max_length=64)]] = Field(default=None, description="`kb_properties` where `property_key = 'tags'`. AND-containment.")
