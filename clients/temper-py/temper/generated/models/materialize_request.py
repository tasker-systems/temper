...
class MaterializeRequest(BaseModel):
    ...
    """ # noqa: E501
    threshold: Optional[StrictInt] = Field(default=None, description="Materialize threshold to gate on; defaults to [`DEFAULT_MATERIALIZE_THRESHOLD`] when omitted.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MaterializeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MaterializeRequest from a dict"""
        if obj is None:
            return None
