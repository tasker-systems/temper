...
class BlobRelationAssertRequest(BaseModel):
    """
    ...
    direction: Optional[BlobRelationDirection] = None
    edge_kind: EdgeKind
    label: StrictStr
    peer_id: UUID
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlobRelationAssertRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlobRelationAssertRequest from a dict"""
        if obj is None:
            return None
