...
class FoldRelationshipRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["confidence", "correlation_id", "invocation_id", "model", "persona", "rationale", "reasoning", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoldRelationshipRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoldRelationshipRequest from a dict"""
        if obj is None:
            return None
