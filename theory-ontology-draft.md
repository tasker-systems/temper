# Ontology draft — `/theory/ontology`

First-pass draft for the ontology page. Introduces the four-layer stratification and the *knowledge-bases-are-misnomers* commitment in its full form.
...
Knowledge is the relationship between a perspective and the information it has produced through intentional engagement with data. Knowledge is not a stored thing; it is a relationship state.
