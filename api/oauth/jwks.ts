/**
 * Temper AS public JWKS (Vercel entry point). Thin wrapper — JWKS building and tests live in
 * `packages/temper-cloud/src/oauth/metadata.ts` (and `src/oauth/keys.ts`).
 */
...
export async function GET(req: Request): Promise<Response> {
  ...
  const { handleJwks } = await import("../../packages/temper-cloud/src/oauth/metadata.js");
