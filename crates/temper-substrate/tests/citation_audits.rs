...
//
// Spec `temper-artifacts:specs/2026-07-23-set5-adversary-citation-audit-design.md` §6.2-6.3,
...
// `temper-artifacts:specs/2026-07-25-auditor-tier1-staleness-watermark-design.md` (rev. 2).
//
