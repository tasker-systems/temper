...
mod tests {
    ...
    ///   cargo nextest run -p temper-next agglomerate_benchmark_large_component --run-ignored all
    /// or `cargo test -p temper-next -- --ignored agglomerate_benchmark_large_component --nocapture`.
