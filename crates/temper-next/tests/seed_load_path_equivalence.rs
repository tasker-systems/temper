...
//!
//! Resets the artifact, ONNX-dependent, serialized via the temper-next-write group.

mod common;

use std::path::Path;
use temper_next::scenario::model::{Scenario, Seed, SeedRef, Step};
use temper_next::scenario::{bootseed, loader, runner};
use temper_next::{embed, replay, substrate, write};
