...
#[openapi(
    ...
    tags(
        ...
        (name = "Teams", description = "Teams — membership, roles, and team-scoped ownership"),
        ...
        (name = "Ingest", description = "Segmented ingest — landing a body too large for a single call"),
