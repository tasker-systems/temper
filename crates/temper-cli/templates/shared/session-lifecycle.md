...
{%- else %}
   ```
   Tool: list_resources   Input: { "doc_type_name": "goal", "context_name": "<current>" }
...
{%- else %}
   ```
   Tool: list_resources   Input: { "doc_type_name": "task", "context_name": "<current>" }
   ```
...
{%- else %}
   ```
   Tool: list_resources   Input: { "doc_type_name": "session", "context_name": "<current>" }
   ```
{%- endif %}
...
{%- else -%}
```
Tool: update_resource_meta   Input: { "id": "<task uuid>", "managed_meta": { "temper-stage": "done" } }
```
{%- endif %}
...
Input: { "id": "<task uuid>", "managed_meta": { "temper-mode": "<new>", "temper-effort": "<new>" } }
```
{%- endif %}
