...
fn loose_graph_config() -> GraphIndexConfig {
    GraphIndexConfig {
        ...
        // stems as gravity wells. Disable the max-df gravity-well filter,
        // the cluster-overlap dedup, and the seed-phrase-similarity dedup
        // (which would otherwise collapse the tight 4-doc fixture's seeds
        // into a single cluster) for these mechanics tests.
        seed_max_doc_frequency_ratio: 1.1,
        cluster_overlap_threshold: 1.1,
        seed_phrase_similarity_threshold: 1.1,
