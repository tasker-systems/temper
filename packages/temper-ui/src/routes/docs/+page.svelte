...
<div class="docs">
  ...
  <section>
    <h2>Install</h2>
    <div class="cli-block">
      <pre><code>cargo install temper-cli</code></pre>
    </div>
    <p>
...
cd temper
cargo install --path crates/temper-cli</code></pre>
    </div>
  </section>
  ...
  <section>
    ...
    <table>
      <tbody>
        <tr><td><code>temper init</code></td><td>Initialize a new vault</td></tr>
        <tr><td><code>temper check</code></td><td>Verify vault integrity and tool health</td></tr>
        <tr><td><code>temper status</code></td><td>Vault overview</td></tr>
        <tr><td><code>temper warmup</code></td><td>Context primer for new sessions</td></tr>
        <tr><td><code>temper events</code></td><td>Show recent vault events</td></tr>
        <tr><td><code>temper normalize</code></td><td>Repair vault structure drift</td></tr>
      </tbody>
    </table>
    ...
    <table>
      <tbody>
        ...
        <tr><td><code>temper session list</code></td><td>List recent sessions</td></tr>
    ...
    <table>
      <tbody>
        <tr><td><code>temper search &lt;query&gt;</code></td><td>Semantic search across the knowledge base</td></tr>
      </tbody>
    </table>
    ...
    <table>
      <tbody>
        ...
        <tr><td><code>temper task list</code></td><td>List tasks grouped by goal</td></tr>
      </tbody>
    </table>

    <h3>Contexts and Skills</h3>
    <table>
      <tbody>
        <tr><td><code>temper context add &lt;name&gt;</code></td><td>Add a context</td></tr>
        <tr><td><code>temper context list</code></td><td>List contexts</td></tr>
        <tr><td><code>temper skill generate</code></td><td>Preview generated Claude Code skill</td></tr>
        <tr><td><code>temper skill install</code></td><td>Install skill file</td></tr>
      </tbody>
    </table>
    ...
    <table>
      <tbody>
        <tr><td><code>temper auth</code></td><td>Authenticate with temper cloud</td></tr>
        <tr><td><code>temper sync</code></td><td>Sync local vault with temper cloud</td></tr>
        <tr><td><code>temper pull &lt;resource&gt;</code></td><td>Pull a resource from the cloud</td></tr>
        <tr><td><code>temper remove &lt;resource&gt;</code></td><td>Remove a resource from the cloud</td></tr>
      </tbody>
    </table>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      Streamable HTTP. Agents authenticate via Auth0 using the standard
      OAuth 2.1 + PKCE flow.
    </p>
    ...
    <table>
      <tbody>
        ...
        <tr><td><code>search</code></td><td>Semantic vector search across the knowledge base</td></tr>
    ...
    <h3>Connect</h3>
    <p>Add to your Claude Desktop or Claude Code MCP configuration:</p>
    <div class="cli-block">
      <pre><code>{`{
  "mcpServers": {
    "temper": {
  ...
  <section>
    ...
    <p>
      To automatically prime new sessions with recent context, add a
      <code>SessionStart</code> hook:
    </p>
    <div class="cli-block">
      <pre><code>{`{
  "hooks": {
