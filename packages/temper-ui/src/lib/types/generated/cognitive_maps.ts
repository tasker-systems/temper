 ...
 */
telos_resource_id: string, staleness: CogmapStaleness, regulation: Array<CogmapRegulationRow>, };
 ...
 */
export type CogmapRegulationRow = { resource_id: string, title: string, body_text: string | null, edge_label: string, };
