 ...
 */
export type ExactHit = { resource_id: string, title: string, 
/**
 * Canonical kb:// URI.
 */
kb_uri: string, 
 ...
 */
origin_uri: string, context: string | null, doc_type: string, 
/**
 ...
 */
export type WideHit = { resource_id: string, title: string, kb_uri: string, origin_uri: string, context: string | null, doc_type: string, context_slug: string | null, context_owner_ref: string | null, 
/**
