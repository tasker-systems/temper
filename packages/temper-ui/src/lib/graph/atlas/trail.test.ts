...
describe('trailModel', () => {
	it('maps events newest-first and humanizes kind', () => {
		const t = trail([
			{ event_id: 'a', kind: 'relationship.asserted', actor_entity_id: 'u1', occurred_at: '2026-01-01T00:00:00Z', confidence: null, actor_name: 'system', payload: {} },
	...
	it('carries a unique row id even when actor+time+kind collide', () => {
		...
		const t = trail([
			{ event_id: 'e1', kind: 'property.set', actor_entity_id: 'u1', occurred_at: '2026-07-05T00:03:08Z', confidence: null, actor_name: 'system', payload: {} },
			{ event_id: 'e2', kind: 'property.set', actor_entity_id: 'u1', occurred_at: '2026-07-05T00:03:08Z', confidence: null, actor_name: 'system', payload: {} }
		]);
