...
> provisioned, registered, admitted, and has recorded a real audit against production. What
> remains is deliberate — the trigger model is still being redesigned (register:
> `docs/superpowers/specs/2026-07-25-auditor-trigger-model-outcome-register.md`), and turning a
> production cron back on is an operator decision, not a consequence of the gates clearing. The
